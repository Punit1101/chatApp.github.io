...
<body>
    ...
    <div class="Sign-up block_center child_center">
        <div class="form_section" style="font-size: medium;">
            ...
            <h4 style="font-size: 17px; margin-top: 15px;">If you don't have account, then <a href="sign_up.php">SIGN UP</a></h4>
        </div>
    </div>
...
<script src="javasc/log_in.js"></script>    
</body>
</html>